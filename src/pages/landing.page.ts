...
import { EstimateFormSection } from "./sections/estimate-form.section";
import { BathBenefitsSection } from "./sections/bath-benefits.section";
...
export class LandingPage {
  ...
  readonly estimateFormPrimary: EstimateFormSection;
  readonly bathBenefitsSection: BathBenefitsSection;
  readonly bathWallsSection: BathWallsSection;
  readonly reviewsSection: ReviewsSection;
  readonly estimateFormSecondary: EstimateFormSection;
  ...
  constructor(page: Page) {
    ...
    this.estimateFormPrimary = new EstimateFormSection(page, 1);
    this.bathBenefitsSection = new BathBenefitsSection(page);
    this.bathWallsSection = new BathWallsSection(page);
    this.reviewsSection = new ReviewsSection(page);
    this.estimateFormSecondary = new EstimateFormSection(page, 2);
  }
